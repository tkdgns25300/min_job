...
| `/mypage/church/info` 교회 정보 | ✅ | ✅ | ✅ | ✅ `e89bebd`+ | **실 저장(2026-08-27)** — `churches` 6칸 + `church_links` 행 + `updateTag("churches")`. 지역·시·군·구 필수, 채널은 `http`/`https`만(`javascript:` 차단), 비우면 행 삭제. 저장 후 화면에 머묾. ⬜ 사진 업로드 |
