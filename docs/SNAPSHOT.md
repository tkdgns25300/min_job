...
>
> ▶ **2026-09-05 소개에 "왜 만들었나요" 신설**(운영자 요청): 1인 신규 서비스라 기능 설명보다 **누가 왜 만들었나**가 신뢰를 만든다고 보고, 개인적인 동기를 세 문단으로 밝혔다 — ① 아버지·누나가 사역 중이고 그 청빙 과정을 가까이서 봤다 ② 만든 사람은 **예장합동 교단 교회 출석** ③ **이단·사이비 공고는 단호히 거절**(수집 단계에서 걸러내고, 교회 직접 등록은 증빙으로 실체를 확인하며, 놓친 건은 이메일 신고로 받아 내린다 — 셋 다 실제로 하는 일이다). **이 페이지에서 유일한 1인칭("저") 구획**이고, 그것이 이 절의 요점이라 다른 절로 번지게 하지 않는다(나머지는 "저희"). 함께 다듬은 것: 히어로 태그라인에서 "여기저기 흩어진"을 빼고(키커·다음 문단이 이미 그 말을 한다), "무엇이 좋은가요" 두 줄의 **어미를 하나로**("~할 수 있습니다" — 나란히 읽히는 두 줄이라 하나만 말투가 다르면 그게 먼저 보인다), FAQ의 "바로 고칩니다"를 **"수정하겠습니다"**로(원문 대조 뒤에 고치므로 속도를 약속할 수 없다). 정본 = SPEC 소개 절.
>
