...
**✅ 초기 마이그레이션 작성 완료 (2026-08-20)** — `supabase/migrations/20260820231650_init.sql`. 테이블 7개 + 제약 + 인덱스. **아직 적용하지 않았다**(원격 DB는 비어 있다). ⬜ RLS·GRANT·Storage 버킷은 다음 마이그레이션 · ⬜ `types/database.ts`는 적용 후 생성
