...
3. ~~BM·노출 상품 재기획~~ ✅ **확정(2026-09-02)** — 자리 셋 + 사다리 3등급(스페셜·플러스·기본) · 정원 3·2 · 9.9/4.9/2.9만/주 · 비슷한 공고 규칙 교체 · 런칭 프로모션 없음. 정본 = SPEC 수익화 절, 근거 = §9. 코드는 아직 2단 — 4에서 함께 전환
...
### G. `/pricing` 페이지 구현 (2026-07-09 — ⬜ 2026-09-02 확정 3등급으로 전환 대기)
...
### H. 노출 결제 flow (`/mypage/church/promote`, 2026-07-20 — ⬜ 상품 목록은 3등급으로 전환 대기)
