...
- **가격**(`EXPOSURE_PRODUCTS.prices` 단일 소스 · 스페셜 6.9/12.9/20.9만 · 플러스 4.9/9.4/14.9만 · 기본 2.9/5.5/8.9만 — 1·2·4주, VAT 포함. 2·4주는 묶음가라 **계산이 아니라 표**다). 결제·검증·적용 구현 완료(2026-09-03 · `completePromotion`), **실연동 채널이라 카드가 실제로 청구된다**(2026-08-05).
