...
- [~] 약관·개인정보처리방침 (`/terms`, `/privacy`) — **초안(placeholder)만 작성됨**. ⚠️ **정식 운영 전 반드시 법률 검토 후 확정** (개인정보보호법·전자상거래법 등; 수집항목·위탁·보유기간·시행일 확정 필요). 로그인·개인정보 처리 시작 전 필수
- [ ] 문의 — 푸터 mailto
...
- [ ] **노출 상품 상세 확정** (선행) — 상품은 **프리미엄·대표광고·끌어올리기 3종으로 진행**하되, **상세(노출 위치·기간 단위·가격·차등 기준·묶음 할인·부가세·결제 수단)와 최종 확정을 여기서 다시** 검토. 이게 돼야 `/pricing` 실제화(라이브 결제) 가능
